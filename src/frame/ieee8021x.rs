...
pub(crate) const WLAN_AUTH_IEEE8021X: u16 = 8;

/// A parsed or buildable IEEE 802.11 IEEE 802.1X Authentication management
/// frame (algorithm 8).
#[derive(Debug, PartialEq, Eq, Clone)]
#[non_exhaustive]
pub struct Ieee80211AuthFrameIeee8021x {
    /// Frame Control.
...
impl Ieee80211AuthFrameIeee8021x {
    /// Create an IEEE 802.1X Authentication frame in the STA-to-AP
    /// direction.
    pub fn new(
        sta_mac: [u8; 6],
        bssid: [u8; 6],
    ...
    /// Parse a full IEEE 802.11 IEEE 802.1X Authentication management frame.
    pub fn parse(data: &[u8]) -> Result<Self, DecodeError> {
        let (fixed, payload) =
            parse_auth_frame(data, Some(WLAN_AUTH_IEEE8021X))?;
...
impl Emitable for Ieee80211AuthFrameIeee8021x {
