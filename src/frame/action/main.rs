...
use super::btm_request::{Ieee80211ActionFrameBtmRequest, Ieee80211BtmRequest};
use super::btm_response::{
    Ieee80211ActionFrameBtmResponse, Ieee80211BtmResponse,
};
use super::buffer::parse_action_frame;
use super::neighbor_report_request::{
    Ieee80211ActionFrameNeighborReportRequest, Ieee80211NeighborReportRequest,
};
use super::neighbor_report_response::{
    Ieee80211ActionFrameNeighborReportResponse, Ieee80211NeighborReportResponse,
};
use super::other::Ieee80211ActionFrameOther;
...
/// are preserved in [`Other`](Self::Other). When an Action category/action
/// pair is missing, please contribute a typed variant upstream instead of
/// hand-building frames; for one-off raw frames,
/// [`Ieee80211ActionFrameOther::new`] can be combined with
/// [`From`] to keep [`Self::Other`] explicit.
...
impl From<Ieee80211ActionFrameNeighborReportRequest> for Ieee80211ActionFrame {
    fn from(frame: Ieee80211ActionFrameNeighborReportRequest) -> Self {
        Self::NeighborReportRequest(frame)
    }
}

impl From<Ieee80211ActionFrameNeighborReportResponse> for Ieee80211ActionFrame {
    fn from(frame: Ieee80211ActionFrameNeighborReportResponse) -> Self {
        Self::NeighborReportResponse(frame)
    }
}

impl From<Ieee80211ActionFrameBtmRequest> for Ieee80211ActionFrame {
    fn from(frame: Ieee80211ActionFrameBtmRequest) -> Self {
        Self::BtmRequest(frame)
    }
}

impl From<Ieee80211ActionFrameBtmResponse> for Ieee80211ActionFrame {
    fn from(frame: Ieee80211ActionFrameBtmResponse) -> Self {
        Self::BtmResponse(frame)
    }
}

impl From<Ieee80211ActionFrameOther> for Ieee80211ActionFrame {
    fn from(frame: Ieee80211ActionFrameOther) -> Self {
        Self::Other(frame)
    }
}
