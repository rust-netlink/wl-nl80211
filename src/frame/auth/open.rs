...
pub(crate) const WLAN_AUTH_OPEN: u16 = 0;

/// A parsed or buildable IEEE 802.11 Open System Authentication management
/// frame (IEEE Std 802.11-2024 Table 9-71: algorithm 0).
#[derive(Debug, PartialEq, Eq, Clone)]
#[non_exhaustive]
pub struct Ieee80211AuthFrameOpenSystem {
    /// Frame Control.
...
impl Ieee80211AuthFrameOpenSystem {
    /// Create an Open System Authentication frame in the STA-to-AP
    /// direction.
    pub fn new(
        sta_mac: [u8; 6],
        bssid: [u8; 6],
    ...
    /// Parse a full IEEE 802.11 Open System Authentication management
    /// frame.
    pub fn parse(data: &[u8]) -> Result<Self, DecodeError> {
        let (fixed, payload) = parse_auth_frame(data, Some(WLAN_AUTH_OPEN))?;
...
impl Emitable for Ieee80211AuthFrameOpenSystem {
